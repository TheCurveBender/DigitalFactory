...
### Feature 2: compute estimated analytic elastic curve of the discrete elastic curve (compute_elastica_parameters)
###

# Compute the analytic curve
options = Array.CreateInstance(Double,1)
analytic_elastica_params = Array.CreateInstance(Double,9)
e.compute_elastica_parameters(P_discrete_elastica, N_segments+1, options, analytic_elastica_params)


### Feature 3: evaluate analytic elastic curve (sample_elastica)
###
...
### Feature 4: design of numerical elastic splines
###
